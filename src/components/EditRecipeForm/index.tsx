...
// src/components/EditRecipeForm/index.tsx
...
import { IFormInput } from "../AddRecipeForm";
...
const EditRecipeForm: React.FC<EditRecipeFormProps> = ({ recipeId }) => {
  ...
  const onSubmit: SubmitHandler<IFormInput> = (data) => {
    const updatedRecipe = { ...data, id: recipeId };
